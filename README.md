...
OTHER VERY IMPORTANT NOTE: LinkedIn will BLOCK you from searching if you are scraping too much data.  DAILY, I have to log in to LinkedIn (via my normal method) to verify that "I am not a bot".  Don't get too greedy with your scrapping!!

### To begin

Prerequisites: Python installed and enviorment established with packages from *requirements.txt* installed.
...
3) Adjust your search criteria for what you want to search for int the .ipynb file
```
...
2) Run "All Cells" on ipynb

FINAL NOTE: I didn't proofread this... sorry